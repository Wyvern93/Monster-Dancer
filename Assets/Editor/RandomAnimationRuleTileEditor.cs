...
{
    /// <summary>
    /// The Editor for a RandomAnimationRuleTile.
    /// </summary>
    [CustomEditor(typeof(RandomAnimationRuleTile), true)]
    [CanEditMultipleObjects]
    public class RandomAnimationRuleTileEditor : Editor
    {
        ...
        private static readonly string k_UndoName = L10n.Tr("Change RandomAnimationRuleTile");
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent emptyRandomAnimationRuleTileInfo =
            ...
            public static readonly GUIContent tilingRulesRandomSprites = EditorGUIUtility.TrTextContent("Random Sprites"
                , "The Sprites to randomize from.");

            public static readonly GUIContent tilingRulesRandomSpritesMinSpeed = EditorGUIUtility.TrTextContent("Min Speed"
                , "The minimum speed at which the animation is played.");
            public static readonly GUIContent tilingRulesRandomSpritesMaxSpeed = EditorGUIUtility.TrTextContent("Max Speed"
                , "The maximum speed at which the animation is played.");
            public static readonly GUIContent tilingRulesRandomSpritesSize = EditorGUIUtility.TrTextContent("Size"
                , "The number of AnimationSprites to randomize from.");
            public static readonly GUIContent tilingRulesRandomSpritesRandomizeStartFrame = EditorGUIUtility.TrTextContent("Randomize Start Frame"
                , "Randomize the starting frame of the animation.");
            public static readonly GUIContent tilingRulesRandomWeight = EditorGUIUtility.TrTextContent("Weight"
                , "The weight of the Sprite in the randomization.");
            public static readonly GUIContent SpriteAnimationSize = EditorGUIUtility.TrTextContent("Size"
        ...
        /// <summary>
        /// The RandomAnimationRuleTile being edited
        /// </summary>
        public RandomAnimationRuleTile tile => target as RandomAnimationRuleTile;
        ...
        /// <summary>
        /// Whether the RandomAnimationRuleTile can extend its neighbors beyond directly adjacent ones
        /// </summary>
        ...
        public const float k_ListLabelWidth = 140f;
        ...
        /// <summary>
        /// OnEnable for the RandomAnimationRuleTileEditor
        /// </summary>
        public virtual void OnEnable()
        {
            m_ReorderableList = new ReorderableList(tile != null ? tile.m_TilingRules : null, typeof(RandomAnimationRuleTile.TilingRule), true, true, true, true);
        ...
        /// <summary>
        /// OnDisable for the RandomAnimationRuleTileEditor
        /// </summary>
        ...
        public virtual BoundsInt GetRuleGUIBounds(BoundsInt bounds, RandomAnimationRuleTile.TilingRule rule)
        {
            if (extendNeighbor)
            {
                bounds.xMin--;
        ...
        {
            RandomAnimationRuleTile.TilingRule rule = tile.m_TilingRules[index];
        ...
        public float GetElementHeight(RandomAnimationRuleTile.TilingRule rule)
        {
            BoundsInt bounds = GetRuleGUIBounds(rule.GetBounds(), rule);

            float inspectorHeight = GetElementHeight(rule as RandomAnimationRuleTile.TilingRuleOutput);
        ...
        public float GetElementHeight(RandomAnimationRuleTile.TilingRuleOutput rule)
        {
            return k_DefaultElementHeight + rule.m_RandomSprites.Sum(randomSprite => k_SingleLineHeight *
                (randomSprite.m_Sprites.Length + 5)) + k_PaddingBetweenRules + k_SingleLineHeight * 4;
            //TODO: à vérif
        }

        /// <summary>
        /// Gets the GUI matrix size for a Rule of a RandomAnimationRuleTile
        /// </summary>
        /// <param name="bounds">Cell bounds of the Rule.</param>
        /// <returns>Returns the GUI matrix size for a Rule of a RandomAnimationRuleTile.</returns>
        ...
        private void OnAddElement(object obj)
        {
            ...
            RandomAnimationRuleTile.TilingRule rule = new RandomAnimationRuleTile.TilingRule
            {
                m_RandomSprites = new RandomAnimationRuleTile.TilingRuleOutput.SpriteAnimation[]
                {
                    new()
                    {
                        m_Sprites = new[]
            ...
            ResizeRandomAnimationRuleTileList(count + 1);
        ...
        /// <summary>
        /// Saves any changes to the RandomAnimationRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Gets all RuleOverrideTiles which override the given RandomAnimationRuleTile
        /// </summary>
        /// <param name="target">RandomAnimationRuleTile which has been updated</param>
        /// <returns>A list of RuleOverrideTiles which override the given RandomAnimationRuleTile</returns>
        public static List<RuleOverrideTile> FindAffectedOverrideTiles(RandomAnimationRuleTile target)
        {
        ...
        /// <summary>
        /// Draws the Inspector GUI for the RandomAnimationRuleTileEditor
        /// </summary>
        public override void OnInspectorGUI()
        {
            ...
            if (count < 0)
                count = 0;
            if (EditorGUI.EndChangeCheck())
                ResizeRandomAnimationRuleTileList(count);
            ...
            if (count == 0)
            {
                ...
                DisplayClipboardText(Styles.emptyRandomAnimationRuleTileInfo, rect);
        ...
        private void ResizeRandomAnimationRuleTileList(int count)
        {
            ...
            if (isEmpty)
            {
                for (int i = 0; i < count; ++i)
                    tile.m_TilingRules[i] = new RandomAnimationRuleTile.TilingRule();
            }
            UpdateTilingRuleIds();
        }

        /// <summary>
        /// Draw editor fields for custom properties for the RandomAnimationRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Gets the index for a Rule with the RandomAnimationRuleTile to display an arrow.
        /// </summary>
        /// <param name="position">The relative position of the arrow from the center.</param>
        /// <returns>Returns the index for a Rule with the RandomAnimationRuleTile to display an arrow.</returns>
        ...
        public virtual void RuleOnGUI(Rect rect, Vector3Int position, int neighbor)
        {
            switch (neighbor)
            {
                case RandomAnimationRuleTile.TilingRuleOutput.Neighbor.This:
                    GUI.DrawTexture(rect, arrows[GetArrowIndex(position)]);
                    break;
                case RandomAnimationRuleTile.TilingRuleOutput.Neighbor.NotThis:
        ...
        public virtual void RuleTransformOnGUI(Rect rect, RandomAnimationRuleTile.TilingRuleOutput.Transform ruleTransform)
        {
            switch (ruleTransform)
            {
                case RandomAnimationRuleTile.TilingRuleOutput.Transform.Rotated:
                    GUI.DrawTexture(rect, autoTransforms[0]);
                    break;
                case RandomAnimationRuleTile.TilingRuleOutput.Transform.MirrorX:
                    GUI.DrawTexture(rect, autoTransforms[1]);
                    break;
                case RandomAnimationRuleTile.TilingRuleOutput.Transform.MirrorY:
                    GUI.DrawTexture(rect, autoTransforms[2]);
                    break;
                case RandomAnimationRuleTile.TilingRuleOutput.Transform.Fixed:
                    GUI.DrawTexture(rect, autoTransforms[3]);
                    break;
                case RandomAnimationRuleTile.TilingRuleOutput.Transform.MirrorXY:
                    GUI.DrawTexture(rect, autoTransforms[4]);
                    break;
                case RandomAnimationRuleTile.TilingRuleOutput.Transform.RotatedMirror:
        ...
        public void RuleNeighborUpdate(Rect rect, RandomAnimationRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position)
        {
        ...
        public void RuleTransformUpdate(Rect rect, RandomAnimationRuleTile.TilingRule tilingRule)
        {
            if (Event.current.type == EventType.MouseDown && ContainsMousePosition(rect))
            {
                tilingRule.m_RuleTransform = (RandomAnimationRuleTile.TilingRuleOutput.Transform)(int)Mathf.Repeat((int)tilingRule.m_RuleTransform + GetMouseChange(), Enum.GetValues(typeof(RandomAnimationRuleTile.TilingRule.Transform)).Length);
                GUI.changed = true;
                Event.current.Use();
            }
        }
        ...
        /// <summary>
        /// Draws a Rule Matrix for the given Rule for a RandomAnimationRuleTile.
        /// </summary>
        ...
        public virtual void RuleMatrixOnGUI(RandomAnimationRuleTile tile, Rect rect, BoundsInt bounds, RandomAnimationRuleTile.TilingRule tilingRule)
        {
        ...
        /// <summary>
        /// Draws a Rule Matrix Icon for the given matching Rule for a RandomAnimationRuleTile with the given position
        /// </summary>
        /// <param name="tilingRule">Tile to draw rule for.</param>
        /// <param name="neighbors">A dictionary of neighbors</param>
        /// <param name="position">The relative position of the neighbor matching Rule</param>
        /// <param name="rect">GUI Rect to draw icon at</param>
        public void RuleMatrixIconOnGUI(RandomAnimationRuleTile.TilingRule tilingRule, Dictionary<Vector3Int, int> neighbors, Vector3Int position, Rect rect)
        {
        ...
        public virtual void SpriteOnGUI(Rect rect, RandomAnimationRuleTile.TilingRuleOutput tilingRule)
        {
            tilingRule.m_RandomSprites[0].m_Sprites[0] = EditorGUI.ObjectField(rect, tilingRule.m_RandomSprites[0].m_Sprites[0], typeof(Sprite), false) as Sprite;
        }
        ...
        public void RuleInspectorOnGUI(Rect rect, RandomAnimationRuleTile.TilingRuleOutput tilingRule)
        {
            var y = rect.yMin;
            ...
            tilingRule.m_RandomTransform = (RandomAnimationRuleTile.TilingRuleOutput.Transform)EditorGUI.EnumPopup(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_RandomTransform);
            y += k_SingleLineHeight;

            var randomSpritesList = new ReorderableList(tilingRule.m_RandomSprites, typeof(RandomAnimationRuleTile.TilingRuleOutput.SpriteAnimation), true, true, true, true)
                {
                    drawHeaderCallback = (r) =>
                    {
                        GUI.Label(r, Styles.tilingRulesRandomSprites);

                        var fieldRect = new Rect(r.xMax - k_DefaultElementHeight, r.y, k_DefaultElementHeight, r.height);
                        var style = EditorGUIUtility.isProSkin ? Styles.extendNeighborsDarkStyle : Styles.extendNeighborsLightStyle;
                        var fieldLabelRect = new Rect(fieldRect.x - 24f, r.y, 24f, r.height);
                        EditorGUI.BeginChangeCheck();
                        var newLength = EditorGUI.DelayedIntField(fieldRect, tilingRule.m_RandomSprites.Length);
                        GUI.Label(fieldLabelRect, Styles.tilingRulesRandomSpritesSize, style);
                        if (!EditorGUI.EndChangeCheck()) return;
                        var oldSize = tilingRule.m_RandomSprites.Length;
                        Array.Resize(ref tilingRule.m_RandomSprites, Math.Max(newLength, 1));
                        if (newLength < 0)
                            newLength = 0;
                        if (newLength <= oldSize) return;
                        for (var i = oldSize; i < newLength; i++) {
                            tilingRule.m_RandomSprites[i] = new RandomAnimationRuleTile.TilingRuleOutput.SpriteAnimation
                            {
                                m_Sprites = new[]
                                {
                                    tilingRule.m_RandomSprites[0].m_Sprites[0]
                                }
                            };
                        }
                    ...
                    {
                        if (i >= tilingRule.m_RandomSprites.Length)
                            return;
                        var yy = r.yMin;
                        var spriteAnimation = tilingRule.m_RandomSprites[i];
                        GUI.Label(new Rect(r.xMin, yy, k_ListLabelWidth, k_SingleLineHeight), Styles.tilingRulesRandomSpritesMinSpeed);
                        spriteAnimation.m_MinAnimationSpeed = EditorGUI.FloatField(new Rect(r.xMin + k_ListLabelWidth, yy, r.width - k_ListLabelWidth, k_SingleLineHeight), spriteAnimation.m_MinAnimationSpeed);
                        yy += k_SingleLineHeight;
                        GUI.Label(new Rect(r.xMin, yy, k_ListLabelWidth, k_SingleLineHeight), Styles.tilingRulesRandomSpritesMaxSpeed);
                        spriteAnimation.m_MaxAnimationSpeed = EditorGUI.FloatField(new Rect(r.xMin + k_ListLabelWidth, yy, r.width - k_ListLabelWidth, k_SingleLineHeight), spriteAnimation.m_MaxAnimationSpeed);
                        yy += k_SingleLineHeight;
                        GUI.Label(new Rect(r.xMin, yy, k_ListLabelWidth, k_SingleLineHeight), Styles.tilingRulesRandomSpritesRandomizeStartFrame);
                        spriteAnimation.m_RandomizeStartFrame = EditorGUI.Toggle(new Rect(r.xMin + k_ListLabelWidth, yy, r.width - k_ListLabelWidth, k_SingleLineHeight), spriteAnimation.m_RandomizeStartFrame);
                        yy += k_SingleLineHeight;
                        GUI.Label(new Rect(r.xMin, yy, k_ListLabelWidth, k_SingleLineHeight), Styles.tilingRulesRandomWeight);
                        spriteAnimation.m_RandomWeight = EditorGUI.Slider(new Rect(r.xMin + k_ListLabelWidth, yy, r.width - k_ListLabelWidth, k_SingleLineHeight), spriteAnimation.m_RandomWeight, 0f, 1f);
                        yy += k_SingleLineHeight;

                        GUI.Label(new Rect(r.xMin, yy, k_ListLabelWidth, k_SingleLineHeight), Styles.SpriteAnimationSize);
                        EditorGUI.BeginChangeCheck();
                        var newAnimLength = EditorGUI.DelayedIntField(new Rect(r.xMin + k_ListLabelWidth, yy, r.width - k_ListLabelWidth, k_SingleLineHeight), spriteAnimation.m_Sprites.Length);
                        if (EditorGUI.EndChangeCheck())
                            Array.Resize(ref spriteAnimation.m_Sprites, Math.Max(newAnimLength, 1));
                        yy += k_SingleLineHeight;

                        for (var ii = 0; ii < spriteAnimation.m_Sprites.Length; ii++) {
                            spriteAnimation.m_Sprites[ii] =
                                EditorGUI.ObjectField(
                                    new Rect(r.xMin + k_ListLabelWidth, yy, r.width - k_ListLabelWidth, k_SingleLineHeight),
                                    spriteAnimation.m_Sprites[ii], typeof(Sprite), false) as Sprite;
                            yy += k_SingleLineHeight;
                        }
                    ...
                    elementHeightCallback = (i) => {
                        var spriteAnimation = tilingRule.m_RandomSprites[i];
                        return k_SingleLineHeight * (spriteAnimation.m_Sprites.Length + 5);
                    },
                    onAddCallback = (l) =>
                    {
                        var count = l.count;
                        Array.Resize(ref tilingRule.m_RandomSprites, count + 1);
                        tilingRule.m_RandomSprites[count] = new RandomAnimationRuleTile.TilingRuleOutput.SpriteAnimation
                        {
                            m_Sprites = new[]
                            {
                                tilingRule.m_RandomSprites[0].m_Sprites[0]
                    ...
                    onRemoveCallback = (l) =>
                    {
                        if (l.index < 1 || l.index >= tilingRule.m_RandomSprites.Length)
                            return;

                        var count = l.count;
                        Array.Copy(tilingRule.m_RandomSprites, l.index + 1, tilingRule.m_RandomSprites, l.index, count - l.index - 1);
                        Array.Resize(ref tilingRule.m_RandomSprites, count - 1);
                        if (l.index >= count - 1)
                            l.index = count - 2;
                        GUI.changed = true;
            ...
            randomSpritesList.DoList(new Rect(rect.xMin, y, rect.width, rect.height - y));
        }
        ...
        private void HandleDragAndDrop(Rect guiRect)
        {
            ...
            switch (Event.current.type)
            {
                ...
                case EventType.DragPerform:
                {
                    ...
                    ResizeRandomAnimationRuleTileList(dragAndDropSprites.Count);
                    for (int i = 0; i < dragAndDropSprites.Count; ++i)
                    {
                        tile.m_TilingRules[i].m_RandomSprites[0].m_Sprites[0] = dragAndDropSprites[i];
                    }
                    DragAndDropClear();
                    GUI.changed = true;
        ...
        /// <summary>
        /// Whether the RandomAnimationRuleTile has a preview GUI
        /// </summary>
        ...
        /// <summary>
        /// Draws the preview GUI for the RandomAnimationRuleTile
        /// </summary>
        ...
        /// <summary>
        /// Creates a Preview for the RandomAnimationRuleTile.
        /// </summary>
        ...
        /// <summary>
        /// Renders a static preview Texture2D for a RandomAnimationRuleTile asset
        /// </summary>
        /// <param name="assetPath">Asset path of the RandomAnimationRuleTile</param>
        ...
        /// <returns>Texture2D containing static preview for the RandomAnimationRuleTile asset</returns>
        ...
        /// </summary>
        [Serializable]
        class RandomAnimationRuleTileRuleWrapper
        {
            /// <summary>
            /// List of Rules to serialize
            /// </summary>
            [SerializeField]
            public List<RandomAnimationRuleTile.TilingRule> rules = new List<RandomAnimationRuleTile.TilingRule>();
        }

        /// <summary>
        /// Copies all Rules from a RandomAnimationRuleTile to the clipboard
        /// </summary>
        /// <param name="item">MenuCommand storing the RandomAnimationRuleTile to copy from</param>
        [MenuItem("CONTEXT/RandomAnimationRuleTile/Copy All Rules")]
        public static void CopyAllRules(MenuCommand item)
        {
            RandomAnimationRuleTile tile = item.context as RandomAnimationRuleTile;
            if (tile == null)
                return;

            RandomAnimationRuleTileRuleWrapper rulesWrapper = new RandomAnimationRuleTileRuleWrapper();
        ...
        /// <summary>
        /// Pastes all Rules from the clipboard to a RandomAnimationRuleTile
        /// </summary>
        /// <param name="item">MenuCommand storing the RandomAnimationRuleTile to paste to</param>
        [MenuItem("CONTEXT/RandomAnimationRuleTile/Paste Rules")]
